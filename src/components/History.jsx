...
function History({ language }) {
  const historyItemsData = {
    ...
    en: [
      {
        year: '2024',
        items: ['2024 PlayX4 Booth Exhibition Participation'],
        position: 'right'
      },
      {
        year: '2025',
        items: [
          "2025 Mandle Contest 'Neglect' 7th Place - 'Banggwanja'",
          "2025 Mandle Contest 'Neglect' 10th Place - 'Nunsarang'",
          "2025 GameAIfy Contest [Excellence Award] - 'Horrops'",
          "2025 Game Talent Foundation Contest [Grand Prize] - 'Ssangnyuk'",
          "2025 Suncheon AI Game Jam [Special Award] - 'Cheonmanhaeyo, Suncheonman'"
        ],
        position: 'left'
      },
      {
        year: '11.06',
        items: ['<Hamstory Demo> Steam Release'],
        position: 'right'
      }
    ]
  }

  const historyItems = historyItemsData[language] || historyItemsData.ko
